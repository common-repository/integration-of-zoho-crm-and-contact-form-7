...
namespace BitCode\BITCF7ZC\Integration;
...
final class Integrations
{
    ...
    {
        if (class_exists("BitCode\\BITCF7ZCPRO\\Integration\\{$name}\\{$name}Handler")) {
            return "BitCode\\BITCF7ZCPRO\\Integration\\{$name}\\{$name}Handler";
        } elseif (file_exists(__DIR__ . '/' . $name) && file_exists(__DIR__ . '/' . $name . '/' . $name . 'Handler.php')) {
    ...
    public function save($data)
    {
        ...
        if (!is_null($missing_field)) {
            wp_send_json_error(sprintf(__('%s cann\'t be empty', 'bitcf7zc'), $missing_field));
        }
        ...
        wp_send_json_success(['id' => $saveStatus, 'msg' => __('Integration saved successfully', 'bitcf7zc')]);
    }
    ...
    public function update($data)
    {
        ...
        wp_send_json_success(__('Integration updated successfully', 'bitcf7zc'));
    }
    ...
    public function delete($data)
    {
        ...
        wp_send_json_success(__('Integration deleted successfully', 'bitcf7zc'));
    }
    ...
    public function toggle_status($data)
    {
        ...
        wp_send_json_success(__('Integration status changed successfully', 'bitcf7zc'));
    }
